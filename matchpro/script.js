...
function cargarLogos() {
    ...
    const fondosConMedidasEspeciales = ['fondo5', 'fondorosa', 'ligamx femenil new', 'ligamx new', 'ligadeexpansion new', 'laliga new', 'premierleague new', 'serie a new', 'serie a 2 new'];
