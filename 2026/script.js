...
function cambiarModoFondo() {
    // Support both old radio-button approach and new toggle UI
    const radio = document.querySelector('input[name="fondoTipo"]:checked');
    if (radio) modoActual = radio.value;
    // If no radio exists, modoActual keeps its current value (set by setMode())
...
function cargarLogos() {
    ...
    const fondosConMedidasEspeciales = ['fondo5', 'fondorosa', 'ligamx3', 'ligamxf3', 'expansion3'];
